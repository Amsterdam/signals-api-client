...
from signals_api_client.api_response import ApiResponse, T as ApiResponseT
import signals_api_client.models
from signals_api_client import rest
from signals_api_client.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(signals_api_client.models, klass)
