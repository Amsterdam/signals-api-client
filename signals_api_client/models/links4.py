...
class Links4(BaseModel):
    ...
    var_self: Optional[Links4Self] = Field(default=None, alias="self")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Links4 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Links4 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "self": Links4Self.from_dict(obj["self"]) if obj.get("self") is not None else None
        })
        return _obj
