...
class PaginatedPrivateDepartmentSerializerListList(BaseModel):
    """
    PaginatedPrivateDepartmentSerializerListList
    """ # noqa: E501
    links: Optional[PaginatedAbridgedChildSignalListLinks] = Field(default=None, alias="_links")
    count: Optional[StrictInt] = None
    results: Optional[List[PrivateDepartmentSerializerList]] = None
    __properties: ClassVar[List[str]] = ["_links", "count", "results"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "_links": PaginatedAbridgedChildSignalListLinks.from_dict(obj["_links"]) if obj.get("_links") is not None else None,
            "count": obj.get("count"),
            "results": [PrivateDepartmentSerializerList.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
        return _obj
