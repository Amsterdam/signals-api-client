...
class NestedLocationModelGeometrie(BaseModel):
    """
    NestedLocationModelGeometrie
    """ # noqa: E501
    type: Optional[StrictStr] = None
    coordinates: Optional[Annotated[List[Union[StrictFloat, StrictInt]], Field(min_length=2, max_length=3)]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NestedLocationModelGeometrie from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NestedLocationModelGeometrie from a dict"""
        if obj is None:
            return None
