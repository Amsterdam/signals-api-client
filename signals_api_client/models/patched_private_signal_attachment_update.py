...
class PatchedPrivateSignalAttachmentUpdate(BaseModel):
    """
    PatchedPrivateSignalAttachmentUpdate
    """ # noqa: E501
    public: Optional[StrictBool] = None
    caption: Optional[Annotated[str, Field(strict=True, max_length=255)]] = None
    __properties: ClassVar[List[str]] = ["public", "caption"]
