...
class PrivateSignalSerializerDetail(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["_links", "_display", "category", "id", "id_display", "has_attachments", "location", "status", "reporter", "priority", "notes", "type", "source", "text", "text_extra", "extra_properties", "created_at", "updated_at", "incident_date_start", "incident_date_end", "directing_departments", "routing_departments", "attachments", "assigned_user_email"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "_links": Links6.from_dict(obj["_links"]) if obj.get("_links") is not None else None,
