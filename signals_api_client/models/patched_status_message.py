...
class PatchedStatusMessage(BaseModel):
    """
    ...
    state: Optional[StateA07Enum] = None
    categories: Optional[List[StrictInt]] = None
    updated_at: Optional[datetime] = None
    created_at: Optional[datetime] = None
    __properties: ClassVar[List[str]] = ["id", "title", "text", "active", "state", "categories", "updated_at", "created_at"]
