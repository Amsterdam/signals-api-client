...
class NestedMySignalLocation(BaseModel):
    """
    NestedMySignalLocation
    """ # noqa: E501
    address: Optional[Any]
    address_text: Optional[StrictStr]
    geometrie: NestedMySignalLocationGeometrie
    __properties: ClassVar[List[str]] = ["address", "address_text", "geometrie"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "geometrie": NestedMySignalLocationGeometrie.from_dict(obj["geometrie"]) if obj.get("geometrie") is not None else None
        })
        return _obj
