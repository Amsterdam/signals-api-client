...
class PublicSignalAttachment(BaseModel):
    """
    PublicSignalAttachment
    """ # noqa: E501
    display: StrictStr = Field(alias="_display")
    links: StrictStr = Field(alias="_links")
    location: StrictStr
    is_image: StrictBool
    created_at: datetime
    file: StrictStr
    __properties: ClassVar[List[str]] = ["_display", "_links", "location", "is_image", "created_at", "file"]
