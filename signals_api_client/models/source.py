...
class Source(BaseModel):
    ...
    description: Annotated[str, Field(strict=True, max_length=3000)]
    is_active: Optional[StrictBool] = None
    can_be_selected: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["id", "name", "description", "is_active", "can_be_selected"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "can_be_selected": obj.get("can_be_selected")
        })
        return _obj
