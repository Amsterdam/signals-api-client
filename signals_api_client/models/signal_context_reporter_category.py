...
class SignalContextReporterCategory(BaseModel):
    """
    SignalContextReporterCategory
    """ # noqa: E501
    sub: Optional[StrictStr] = None
    sub_slug: Optional[StrictStr] = None
    departments: Optional[StrictStr] = None
    main: Optional[StrictStr] = None
    main_slug: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["sub", "sub_slug", "departments", "main", "main_slug"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "sub": obj.get("sub"),
            "sub_slug": obj.get("sub_slug"),
            "departments": obj.get("departments"),
            "main": obj.get("main"),
            "main_slug": obj.get("main_slug")
        })
        return _obj
