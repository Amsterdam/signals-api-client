...
class PatchedExpression(BaseModel):
    """
    PatchedExpression
    """ # noqa: E501
    ...
    routing_department: Optional[RoutingExpression] = None
    __properties: ClassVar[List[str]] = ["id", "name", "code", "type", "routing_department"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of routing_department
        if self.routing_department:
            _dict['routing_department'] = self.routing_department.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "code": obj.get("code"),
            "type": obj.get("type"),
            "routing_department": RoutingExpression.from_dict(obj["routing_department"]) if obj.get("routing_department") is not None else None
        })
        return _obj
