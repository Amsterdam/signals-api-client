...
class SignalsPerCategoryCount(BaseModel):
    """
    SignalsPerCategoryCount
    """ # noqa: E501
    category: SimpleCategory
    signal_count: StrictInt
    __properties: ClassVar[List[str]] = ["category", "signal_count"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "category": SimpleCategory.from_dict(obj["category"]) if obj.get("category") is not None else None,
