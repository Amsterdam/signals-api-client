...
class ReportSignalsPerCategory(BaseModel):
    """
    ReportSignalsPerCategory
    """ # noqa: E501
    total_signal_count: StrictInt
    results: SignalsPerCategoryCount
    __properties: ClassVar[List[str]] = ["total_signal_count", "results"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "results": SignalsPerCategoryCount.from_dict(obj["results"]) if obj.get("results") is not None else None
        })
        return _obj
