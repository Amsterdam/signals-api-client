...
class V1PrivateSignalsGeographyRetrieve200ResponseFeaturesInnerProperties(BaseModel):
    """
    V1PrivateSignalsGeographyRetrieve200ResponseFeaturesInnerProperties
    """ # noqa: E501
