...
class SignalList(BaseModel):
    ...
    SignalList
    """ # noqa: E501
    links: Links9 = Field(alias="_links")
    ...
    created_at: datetime
    __properties: ClassVar[List[str]] = ["_links", "_display", "uuid", "id_display", "text", "status", "created_at"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "_links": Links9.from_dict(obj["_links"]) if obj.get("_links") is not None else None,
