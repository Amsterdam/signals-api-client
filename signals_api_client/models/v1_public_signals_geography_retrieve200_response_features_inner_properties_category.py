...
class V1PublicSignalsGeographyRetrieve200ResponseFeaturesInnerPropertiesCategory(BaseModel):
    """
    V1PublicSignalsGeographyRetrieve200ResponseFeaturesInnerPropertiesCategory
    """ # noqa: E501
    name: Optional[StrictStr] = None
    slug: Optional[StrictStr] = None
    parent: Optional[V1PublicSignalsGeographyRetrieve200ResponseFeaturesInnerPropertiesCategoryParent] = None
    __properties: ClassVar[List[str]] = ["name", "slug", "parent"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "slug": obj.get("slug"),
            "parent": V1PublicSignalsGeographyRetrieve200ResponseFeaturesInnerPropertiesCategoryParent.from_dict(obj["parent"]) if obj.get("parent") is not None else None
        })
        return _obj
