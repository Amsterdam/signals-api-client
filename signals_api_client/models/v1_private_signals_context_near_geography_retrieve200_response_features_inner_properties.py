...
class V1PrivateSignalsContextNearGeographyRetrieve200ResponseFeaturesInnerProperties(BaseModel):
    """
    V1PrivateSignalsContextNearGeographyRetrieve200ResponseFeaturesInnerProperties
    """ # noqa: E501
    state: Optional[StrictStr] = None
    state_display: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["state", "state_display"]
    ...
    def state_validate_enum(cls, value):
        ...
        if value not in set(['m', 'i', 'b', 'h', 'ingepland', 'ready to send', 'o', 'a', 'reopened', 's', 'closure requested', 'reaction requested', 'reaction received', 'forward to external']):
            raise ValueError("must be one of enum values ('m', 'i', 'b', 'h', 'ingepland', 'ready to send', 'o', 'a', 'reopened', 's', 'closure requested', 'reaction requested', 'reaction received', 'forward to external')")
        return value
