...
class V1PublicSignalsGeographyRetrieve200ResponseFeaturesInner(BaseModel):
    """
    ...
    properties: Optional[V1PublicSignalsGeographyRetrieve200ResponseFeaturesInnerProperties] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "properties": V1PublicSignalsGeographyRetrieve200ResponseFeaturesInnerProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
