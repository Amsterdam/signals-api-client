...
class StatusMessageFacet(BaseModel):
    """
    StatusMessageFacet
    """ # noqa: E501
    state: List[StateTermsFacet]
    active: List[ActiveTermsFacet]
    __properties: ClassVar[List[str]] = ["state", "active"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "state": [StateTermsFacet.from_dict(_item) for _item in obj["state"]] if obj.get("state") is not None else None,
            "active": [ActiveTermsFacet.from_dict(_item) for _item in obj["active"]] if obj.get("active") is not None else None
        })
        return _obj
