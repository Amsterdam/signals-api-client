...
class AbridgedChildSignal(BaseModel):
    """
    AbridgedChildSignal
    """ # noqa: E501
    ...
    category: StrictStr
    updated_at: datetime
    can_view_signal: StrictStr
    __properties: ClassVar[List[str]] = ["_links", "id", "status", "category", "updated_at", "can_view_signal"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "can_view_signal": obj.get("can_view_signal")
        })
        return _obj
