...
class StatusMessageCategoryPosition(BaseModel):
    """
    Serializer for the StatusMessageCategory model used for ordering status messages.
    """ # noqa: E501
    status_message: Annotated[int, Field(strict=True, ge=1)]
    position: Annotated[int, Field(strict=True, ge=0)]
    __properties: ClassVar[List[str]] = ["status_message", "position"]
