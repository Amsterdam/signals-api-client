...
class HistoryLogHal(BaseModel):
    """
    HistoryLogHal
    """ # noqa: E501
    when: datetime
    what: StrictStr = Field(description="\"what\" in the style of the signals_history_view Present for backwards compatibility")
    action: StrictStr
    description: StrictStr
    signal: StrictStr = Field(alias="_signal")
    __properties: ClassVar[List[str]] = ["when", "what", "action", "description", "_signal"]
