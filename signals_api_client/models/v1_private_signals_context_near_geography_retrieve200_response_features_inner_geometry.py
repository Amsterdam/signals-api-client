...
class V1PrivateSignalsContextNearGeographyRetrieve200ResponseFeaturesInnerGeometry(BaseModel):
    """
    V1PrivateSignalsContextNearGeographyRetrieve200ResponseFeaturesInnerGeometry
    """ # noqa: E501
