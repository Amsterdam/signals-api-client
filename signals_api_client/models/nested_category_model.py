...
class NestedCategoryModel(BaseModel):
    ...
    deadline: datetime
    deadline_factor_3: datetime
    __properties: ClassVar[List[str]] = ["sub_category", "sub", "sub_slug", "main", "main_slug", "category_url", "departments", "created_by", "text", "deadline", "deadline_factor_3"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "deadline_factor_3": obj.get("deadline_factor_3")
        })
        return _obj
