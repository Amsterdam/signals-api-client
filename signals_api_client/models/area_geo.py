...
class AreaGeo(BaseModel):
    """
    AreaGeo
    """ # noqa: E501
    type: Optional[GisFeatureEnum] = None
    geometry: Optional[AreaCreateGeometry] = None
    properties: Optional[AreaGeoProperties] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "geometry": AreaCreateGeometry.from_dict(obj["geometry"]) if obj.get("geometry") is not None else None,
            "properties": AreaGeoProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
