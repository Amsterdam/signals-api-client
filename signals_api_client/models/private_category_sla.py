...
class PrivateCategorySLA(BaseModel):
    """
    PrivateCategorySLA
    """ # noqa: E501
    n_days: Annotated[int, Field(le=2147483647, strict=True, ge=-2147483648)]
    use_calendar_days: Optional[StrictBool] = Field(default=None, description="* `True` - Kalender dagen * `False` - Werk dagen")
    __properties: ClassVar[List[str]] = ["n_days", "use_calendar_days"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "use_calendar_days": obj.get("use_calendar_days")
        })
        return _obj
