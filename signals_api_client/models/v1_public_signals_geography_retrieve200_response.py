...
class V1PublicSignalsGeographyRetrieve200Response(BaseModel):
    """
    V1PublicSignalsGeographyRetrieve200Response
    """ # noqa: E501
    type: Optional[StrictStr] = None
    features: Optional[List[V1PublicSignalsGeographyRetrieve200ResponseFeaturesInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "features": [V1PublicSignalsGeographyRetrieve200ResponseFeaturesInner.from_dict(_item) for _item in obj["features"]] if obj.get("features") is not None else None
        })
        return _obj
