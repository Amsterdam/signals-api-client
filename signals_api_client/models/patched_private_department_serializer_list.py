...
class PatchedPrivateDepartmentSerializerList(BaseModel):
    """
    ...
    code: Optional[Annotated[str, Field(strict=True, max_length=3)]] = None
    is_intern: Optional[StrictBool] = None
    category_names: Optional[List[StrictStr]] = None
    can_direct: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["_links", "_display", "id", "name", "code", "is_intern", "category_names", "can_direct"]
