...
class V1PublicSignalsGeographyRetrieve200ResponseFeaturesInnerPropertiesCategoryParent(BaseModel):
    """
    V1PublicSignalsGeographyRetrieve200ResponseFeaturesInnerPropertiesCategoryParent
    """ # noqa: E501
