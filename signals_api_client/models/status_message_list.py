...
class StatusMessageList(BaseModel):
    """
    StatusMessageList
    """ # noqa: E501
    count: StrictInt
    results: List[StatusMessageSearchResult]
    facets: StatusMessageFacet
    __properties: ClassVar[List[str]] = ["count", "results", "facets"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "count": obj.get("count"),
            "results": [StatusMessageSearchResult.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None,
            "facets": StatusMessageFacet.from_dict(obj["facets"]) if obj.get("facets") is not None else None
        })
        return _obj
