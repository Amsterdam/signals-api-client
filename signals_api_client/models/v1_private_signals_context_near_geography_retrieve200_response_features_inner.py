...
class V1PrivateSignalsContextNearGeographyRetrieve200ResponseFeaturesInner(BaseModel):
    """
    V1PrivateSignalsContextNearGeographyRetrieve200ResponseFeaturesInner
    """ # noqa: E501
    type: Optional[StrictStr] = None
    geometry: Optional[V1PrivateSignalsContextNearGeographyRetrieve200ResponseFeaturesInnerGeometry] = None
    properties: Optional[V1PrivateSignalsContextNearGeographyRetrieve200ResponseFeaturesInnerProperties] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "properties": V1PrivateSignalsContextNearGeographyRetrieve200ResponseFeaturesInnerProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
