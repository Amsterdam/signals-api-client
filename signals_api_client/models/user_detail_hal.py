...
class UserDetailHAL(BaseModel):
    ...
    """ # noqa: E501
    links: Links4 = Field(alias="_links")
    ...
    is_staff: StrictBool = Field(description="Bepaalt of de gebruiker zich op deze beheerwebsite kan aanmelden.")
    is_superuser: StrictBool = Field(description="Bepaalt dat deze gebruiker alle rechten heeft, zonder deze expliciet toe te wijzen.")
    roles: List[Role]
