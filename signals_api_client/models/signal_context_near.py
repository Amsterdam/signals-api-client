...
class SignalContextNear(BaseModel):
    """
    SignalContextNear
    """ # noqa: E501
    signal_count: Optional[StrictInt] = Field(default=None, description="The number of signals in the same category as the current signal, within a radius of 500 meters, created in the last 4 weeks.")
    __properties: ClassVar[List[str]] = ["signal_count"]
