...
AuthSettings = TypedDict(
    "AuthSettings",
    {
        "JWTAuthBackend": BearerFormatAuthSetting,
...
conf = signals_api_client.Configuration(
    ...
    def __init__(
        ...
        *,
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("signals_api_client")
