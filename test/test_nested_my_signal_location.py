...
class TestNestedMySignalLocation(unittest.TestCase):
    """NestedMySignalLocation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NestedMySignalLocation:
        """Test NestedMySignalLocation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NestedMySignalLocation`
        """
        model = NestedMySignalLocation()
        if include_optional:
            return NestedMySignalLocation(
                address = None,
                address_text = '',
    ...
    def testNestedMySignalLocation(self):
        """Test NestedMySignalLocation"""
