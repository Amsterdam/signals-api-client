...
class TestEmailPreviewPost(unittest.TestCase):
    """EmailPreviewPost unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EmailPreviewPost:
        """Test EmailPreviewPost
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EmailPreviewPost`
        """
        model = EmailPreviewPost()
        if include_optional:
            return EmailPreviewPost(
                status = 'm',
                text = '',
                email_override = ''
            )
