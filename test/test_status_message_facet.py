...
class TestStatusMessageFacet(unittest.TestCase):
    """StatusMessageFacet unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StatusMessageFacet:
        """Test StatusMessageFacet
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StatusMessageFacet`
        """
        model = StatusMessageFacet()
        if include_optional:
            return StatusMessageFacet(
                state = [
    ...
    def testStatusMessageFacet(self):
        """Test StatusMessageFacet"""
