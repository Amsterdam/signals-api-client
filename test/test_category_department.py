...
class TestCategoryDepartment(unittest.TestCase):
    """CategoryDepartment unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CategoryDepartment:
        """Test CategoryDepartment
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CategoryDepartment`
        """
    ...
    def testCategoryDepartment(self):
        """Test CategoryDepartment"""
