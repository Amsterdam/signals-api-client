...
class TestLinks8Archives(unittest.TestCase):
    """Links8Archives unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Links8Archives:
        """Test Links8Archives
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Links8Archives`
        """
        model = Links8Archives()
        if include_optional:
            return Links8Archives(
