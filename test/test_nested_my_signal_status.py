...
class TestNestedMySignalStatus(unittest.TestCase):
    """NestedMySignalStatus unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NestedMySignalStatus:
        """Test NestedMySignalStatus
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NestedMySignalStatus`
        """
        model = NestedMySignalStatus()
        if include_optional:
            return NestedMySignalStatus(
                state = '',
                state_display = ''
            )
        else:
    ...
    def testNestedMySignalStatus(self):
        """Test NestedMySignalStatus"""
