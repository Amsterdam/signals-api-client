...
class TestPatchedFeedback(unittest.TestCase):
    """PatchedFeedback unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PatchedFeedback:
        """Test PatchedFeedback
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PatchedFeedback`
        """
        model = PatchedFeedback()
        if include_optional:
