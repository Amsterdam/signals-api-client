...
class TestActiveTermsFacet(unittest.TestCase):
    """ActiveTermsFacet unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActiveTermsFacet:
        """Test ActiveTermsFacet
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActiveTermsFacet`
        """
        model = ActiveTermsFacet()
        if include_optional:
            return ActiveTermsFacet(
                count = 56,
                active = True,
                term = True
            )
