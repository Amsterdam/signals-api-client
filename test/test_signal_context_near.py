...
class TestSignalContextNear(unittest.TestCase):
    """SignalContextNear unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SignalContextNear:
        """Test SignalContextNear
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SignalContextNear`
        """
        model = SignalContextNear()
        if include_optional:
            return SignalContextNear(
                signal_count = 5
            )
        else:
            return SignalContextNear(
    ...
    def testSignalContextNear(self):
        """Test SignalContextNear"""
