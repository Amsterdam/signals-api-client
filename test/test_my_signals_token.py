...
class TestMySignalsToken(unittest.TestCase):
    """MySignalsToken unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MySignalsToken:
        """Test MySignalsToken
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MySignalsToken`
        """
        model = MySignalsToken()
        if include_optional:
            return MySignalsToken(
                email = ''
            )
        else:
            return MySignalsToken(
