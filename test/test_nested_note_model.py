...
class TestNestedNoteModel(unittest.TestCase):
    """NestedNoteModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NestedNoteModel:
        """Test NestedNoteModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NestedNoteModel`
        """
        model = NestedNoteModel()
        if include_optional:
            return NestedNoteModel(
                text = '',
                created_by = ''
            )
        else:
