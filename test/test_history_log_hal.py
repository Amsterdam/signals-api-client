...
class TestHistoryLogHal(unittest.TestCase):
    """HistoryLogHal unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HistoryLogHal:
        """Test HistoryLogHal
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HistoryLogHal`
        """
        model = HistoryLogHal()
        if include_optional:
            return HistoryLogHal(
