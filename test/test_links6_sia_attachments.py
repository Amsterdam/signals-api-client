...
class TestLinks6SiaAttachments(unittest.TestCase):
    """Links6SiaAttachments unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Links6SiaAttachments:
        """Test Links6SiaAttachments
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Links6SiaAttachments`
        """
        model = Links6SiaAttachments()
        if include_optional:
            return Links6SiaAttachments(
    ...
    def testLinks6SiaAttachments(self):
        """Test Links6SiaAttachments"""
