...
class TestPrivateCategoryIcon(unittest.TestCase):
    """PrivateCategoryIcon unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PrivateCategoryIcon:
        """Test PrivateCategoryIcon
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PrivateCategoryIcon`
        """
        model = PrivateCategoryIcon()
        if include_optional:
            return PrivateCategoryIcon(
                icon = ''
            )
        else:
            return PrivateCategoryIcon(
    ...
    def testPrivateCategoryIcon(self):
        """Test PrivateCategoryIcon"""
