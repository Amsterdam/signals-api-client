...
class TestPaginatedAbridgedChildSignalListLinksSelf(unittest.TestCase):
    """PaginatedAbridgedChildSignalListLinksSelf unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaginatedAbridgedChildSignalListLinksSelf:
        """Test PaginatedAbridgedChildSignalListLinksSelf
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaginatedAbridgedChildSignalListLinksSelf`
        """
        model = PaginatedAbridgedChildSignalListLinksSelf()
        if include_optional:
            return PaginatedAbridgedChildSignalListLinksSelf(
    ...
    def testPaginatedAbridgedChildSignalListLinksSelf(self):
        """Test PaginatedAbridgedChildSignalListLinksSelf"""
