...
class TestPrivateCategorySLA(unittest.TestCase):
    """PrivateCategorySLA unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PrivateCategorySLA:
        """Test PrivateCategorySLA
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PrivateCategorySLA`
        """
        model = PrivateCategorySLA()
        if include_optional:
            return PrivateCategorySLA(
                n_days = -2147483648,
    ...
    def testPrivateCategorySLA(self):
        """Test PrivateCategorySLA"""
