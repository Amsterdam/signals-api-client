...
class TestLinks4(unittest.TestCase):
    """Links4 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Links4:
        """Test Links4
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Links4`
        """
        model = Links4()
        if include_optional:
            return Links4(
                ...
                var_self = signals_api_client.models._links_4_self._links_4_self(
