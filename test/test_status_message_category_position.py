...
class TestStatusMessageCategoryPosition(unittest.TestCase):
    """StatusMessageCategoryPosition unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StatusMessageCategoryPosition:
        """Test StatusMessageCategoryPosition
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StatusMessageCategoryPosition`
        """
        model = StatusMessageCategoryPosition()
        if include_optional:
            return StatusMessageCategoryPosition(
                status_message = 1,
                position = 0
            )
        else:
    ...
    def testStatusMessageCategoryPosition(self):
        """Test StatusMessageCategoryPosition"""
