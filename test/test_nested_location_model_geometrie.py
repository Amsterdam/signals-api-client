...
class TestNestedLocationModelGeometrie(unittest.TestCase):
    """NestedLocationModelGeometrie unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NestedLocationModelGeometrie:
        """Test NestedLocationModelGeometrie
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NestedLocationModelGeometrie`
        """
        model = NestedLocationModelGeometrie()
        if include_optional:
            return NestedLocationModelGeometrie(
                type = 'Point',
    ...
    def testNestedLocationModelGeometrie(self):
        """Test NestedLocationModelGeometrie"""
