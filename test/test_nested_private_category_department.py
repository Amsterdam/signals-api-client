...
class TestNestedPrivateCategoryDepartment(unittest.TestCase):
    """NestedPrivateCategoryDepartment unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NestedPrivateCategoryDepartment:
        """Test NestedPrivateCategoryDepartment
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NestedPrivateCategoryDepartment`
        """
        model = NestedPrivateCategoryDepartment()
        if include_optional:
            return NestedPrivateCategoryDepartment(
                id = 56,
                code = '',
                name = '',
                is_intern = True,
    ...
    def testNestedPrivateCategoryDepartment(self):
        """Test NestedPrivateCategoryDepartment"""
