...
class TestAreaGeoProperties(unittest.TestCase):
    """AreaGeoProperties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AreaGeoProperties:
        """Test AreaGeoProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AreaGeoProperties`
        """
        model = AreaGeoProperties()
        if include_optional:
            return AreaGeoProperties(
                name = '',
                code = '',
    ...
    def testAreaGeoProperties(self):
        """Test AreaGeoProperties"""
