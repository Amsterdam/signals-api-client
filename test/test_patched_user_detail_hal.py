...
class TestPatchedUserDetailHAL(unittest.TestCase):
    """PatchedUserDetailHAL unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PatchedUserDetailHAL:
        """Test PatchedUserDetailHAL
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PatchedUserDetailHAL`
        """
        model = PatchedUserDetailHAL()
        if include_optional:
            return PatchedUserDetailHAL(
    ...
    def testPatchedUserDetailHAL(self):
        """Test PatchedUserDetailHAL"""
