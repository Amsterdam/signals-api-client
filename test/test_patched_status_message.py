...
class TestPatchedStatusMessage(unittest.TestCase):
    """PatchedStatusMessage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PatchedStatusMessage:
        """Test PatchedStatusMessage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PatchedStatusMessage`
        """
        model = PatchedStatusMessage()
        if include_optional:
            return PatchedStatusMessage(
                id = 56,
                title = '',
                text = '',
                active = True,
    ...
    def testPatchedStatusMessage(self):
        """Test PatchedStatusMessage"""
