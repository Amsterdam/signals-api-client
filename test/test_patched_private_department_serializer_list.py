...
class TestPatchedPrivateDepartmentSerializerList(unittest.TestCase):
    """PatchedPrivateDepartmentSerializerList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PatchedPrivateDepartmentSerializerList:
        """Test PatchedPrivateDepartmentSerializerList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PatchedPrivateDepartmentSerializerList`
        """
        model = PatchedPrivateDepartmentSerializerList()
        if include_optional:
            return PatchedPrivateDepartmentSerializerList(
    ...
    def testPatchedPrivateDepartmentSerializerList(self):
        """Test PatchedPrivateDepartmentSerializerList"""
