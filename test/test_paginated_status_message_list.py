...
class TestPaginatedStatusMessageList(unittest.TestCase):
    """PaginatedStatusMessageList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaginatedStatusMessageList:
        """Test PaginatedStatusMessageList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaginatedStatusMessageList`
        """
        model = PaginatedStatusMessageList()
        if include_optional:
            return PaginatedStatusMessageList(
                ...
                count = 123,
                results = [
                    signals_api_client.models.status_message.StatusMessage(
                        id = 56, 
                        title = '', 
                        text = '', 
                        active = True, 
    ...
    def testPaginatedStatusMessageList(self):
        """Test PaginatedStatusMessageList"""
