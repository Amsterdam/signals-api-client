...
class TestPaginatedAbridgedChildSignalListLinksPrevious(unittest.TestCase):
    """PaginatedAbridgedChildSignalListLinksPrevious unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaginatedAbridgedChildSignalListLinksPrevious:
        """Test PaginatedAbridgedChildSignalListLinksPrevious
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaginatedAbridgedChildSignalListLinksPrevious`
        """
        model = PaginatedAbridgedChildSignalListLinksPrevious()
        if include_optional:
            return PaginatedAbridgedChildSignalListLinksPrevious(
    ...
    def testPaginatedAbridgedChildSignalListLinksPrevious(self):
        """Test PaginatedAbridgedChildSignalListLinksPrevious"""
