...
class TestLinks7SiaContextGeographyDetail(unittest.TestCase):
    """Links7SiaContextGeographyDetail unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Links7SiaContextGeographyDetail:
        """Test Links7SiaContextGeographyDetail
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Links7SiaContextGeographyDetail`
        """
        model = Links7SiaContextGeographyDetail()
        if include_optional:
            return Links7SiaContextGeographyDetail(
    ...
    def testLinks7SiaContextGeographyDetail(self):
        """Test Links7SiaContextGeographyDetail"""
