...
class TestLinks4Self(unittest.TestCase):
    """Links4Self unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Links4Self:
        """Test Links4Self
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Links4Self`
        """
        model = Links4Self()
        if include_optional:
            return Links4Self(
