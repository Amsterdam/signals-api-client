...
class TestLinks7SiaContextReporterDetail(unittest.TestCase):
    """Links7SiaContextReporterDetail unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Links7SiaContextReporterDetail:
        """Test Links7SiaContextReporterDetail
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Links7SiaContextReporterDetail`
        """
        model = Links7SiaContextReporterDetail()
        if include_optional:
            return Links7SiaContextReporterDetail(
    ...
    def testLinks7SiaContextReporterDetail(self):
        """Test Links7SiaContextReporterDetail"""
