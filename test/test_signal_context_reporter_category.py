...
class TestSignalContextReporterCategory(unittest.TestCase):
    """SignalContextReporterCategory unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SignalContextReporterCategory:
        """Test SignalContextReporterCategory
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SignalContextReporterCategory`
        """
        model = SignalContextReporterCategory()
        if include_optional:
            return SignalContextReporterCategory(
                sub = 'Overig',
                sub_slug = 'overig',
                departments = 'ASC, WAT',
                main = 'Overig',
    ...
    def testSignalContextReporterCategory(self):
        """Test SignalContextReporterCategory"""
