...
class TestNestedDepartmentModel(unittest.TestCase):
    """NestedDepartmentModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NestedDepartmentModel:
        """Test NestedDepartmentModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NestedDepartmentModel`
        """
        model = NestedDepartmentModel()
        if include_optional:
            return NestedDepartmentModel(
                id = 56,
                code = '',
                name = '',
                is_intern = True
    ...
    def testNestedDepartmentModel(self):
        """Test NestedDepartmentModel"""
