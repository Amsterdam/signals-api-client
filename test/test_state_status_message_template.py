...
class TestStateStatusMessageTemplate(unittest.TestCase):
    """StateStatusMessageTemplate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StateStatusMessageTemplate:
        """Test StateStatusMessageTemplate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StateStatusMessageTemplate`
        """
        model = StateStatusMessageTemplate()
        if include_optional:
            return StateStatusMessageTemplate(
                state = 'm',
                templates = ''
            )
        else:
    ...
    def testStateStatusMessageTemplate(self):
        """Test StateStatusMessageTemplate"""
