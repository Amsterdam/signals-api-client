...
class TestTemporaryCategoryHAL(unittest.TestCase):
    """TemporaryCategoryHAL unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TemporaryCategoryHAL:
        """Test TemporaryCategoryHAL
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TemporaryCategoryHAL`
        """
        model = TemporaryCategoryHAL()
        if include_optional:
            return TemporaryCategoryHAL(
    ...
    def testTemporaryCategoryHAL(self):
        """Test TemporaryCategoryHAL"""
