...
class TestNestedStatusModelTargetApi(unittest.TestCase):
    """NestedStatusModelTargetApi unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NestedStatusModelTargetApi:
        """Test NestedStatusModelTargetApi
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NestedStatusModelTargetApi`
        """
        model = NestedStatusModelTargetApi()
        if include_optional:
            return NestedStatusModelTargetApi(
            )
        else:
            return NestedStatusModelTargetApi(
        )
    ...
    def testNestedStatusModelTargetApi(self):
        """Test NestedStatusModelTargetApi"""
