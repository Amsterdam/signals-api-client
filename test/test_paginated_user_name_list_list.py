...
class TestPaginatedUserNameListList(unittest.TestCase):
    """PaginatedUserNameListList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaginatedUserNameListList:
        """Test PaginatedUserNameListList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaginatedUserNameListList`
        """
        model = PaginatedUserNameListList()
        if include_optional:
            return PaginatedUserNameListList(
                ...
                count = 123,
                results = [
                    signals_api_client.models.user_name_list.UserNameList(
                        username = 'A', )
                    ]
            )
        else:
    ...
    def testPaginatedUserNameListList(self):
        """Test PaginatedUserNameListList"""
