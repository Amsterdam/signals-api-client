...
class TestLinks5(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Links5:
        """Test Links5
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Links5`
        """
        model = Links5()
        if include_optional:
            return Links5(
                var_self = signals_api_client.models._links_5_self._links_5_self(
