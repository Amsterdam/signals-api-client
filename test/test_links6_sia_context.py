...
class TestLinks6SiaContext(unittest.TestCase):
    """Links6SiaContext unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Links6SiaContext:
        """Test Links6SiaContext
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Links6SiaContext`
        """
        model = Links6SiaContext()
        if include_optional:
            return Links6SiaContext(
