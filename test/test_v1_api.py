...
class TestV1Api(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_v1_private_area_create(self) -> None:
        """Test case for v1_private_area_create

        """
        pass

    async def test_v1_private_area_types_create(self) -> None:
        """Test case for v1_private_area_types_create

        """
        pass

    async def test_v1_private_area_types_list(self) -> None:
        """Test case for v1_private_area_types_list
