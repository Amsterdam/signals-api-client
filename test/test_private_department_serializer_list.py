...
class TestPrivateDepartmentSerializerList(unittest.TestCase):
    """PrivateDepartmentSerializerList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PrivateDepartmentSerializerList:
        """Test PrivateDepartmentSerializerList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PrivateDepartmentSerializerList`
        """
        model = PrivateDepartmentSerializerList()
        if include_optional:
            return PrivateDepartmentSerializerList(
    ...
    def testPrivateDepartmentSerializerList(self):
        """Test PrivateDepartmentSerializerList"""
