...
class TestSignalContextReporterFeedback(unittest.TestCase):
    """SignalContextReporterFeedback unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SignalContextReporterFeedback:
        """Test SignalContextReporterFeedback
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SignalContextReporterFeedback`
        """
        model = SignalContextReporterFeedback()
        if include_optional:
            return SignalContextReporterFeedback(
                is_satisfied = True,
    ...
    def testSignalContextReporterFeedback(self):
        """Test SignalContextReporterFeedback"""
