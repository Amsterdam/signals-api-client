...
class TestNestedMySignalLocationGeometrie(unittest.TestCase):
    """NestedMySignalLocationGeometrie unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NestedMySignalLocationGeometrie:
        """Test NestedMySignalLocationGeometrie
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NestedMySignalLocationGeometrie`
        """
        model = NestedMySignalLocationGeometrie()
        if include_optional:
            return NestedMySignalLocationGeometrie(
                type = 'Point',
    ...
    def testNestedMySignalLocationGeometrie(self):
        """Test NestedMySignalLocationGeometrie"""
