...
class TestNestedReporterModel(unittest.TestCase):
    """NestedReporterModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NestedReporterModel:
        """Test NestedReporterModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NestedReporterModel`
        """
        model = NestedReporterModel()
        if include_optional:
            return NestedReporterModel(
                email = '',
                phone = '',
    ...
    def testNestedReporterModel(self):
        """Test NestedReporterModel"""
