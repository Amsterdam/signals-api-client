...
class TestPrivateSignalAttachmentUpdate(unittest.TestCase):
    """PrivateSignalAttachmentUpdate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PrivateSignalAttachmentUpdate:
        """Test PrivateSignalAttachmentUpdate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PrivateSignalAttachmentUpdate`
        """
        model = PrivateSignalAttachmentUpdate()
        if include_optional:
            return PrivateSignalAttachmentUpdate(
                public = True,
                caption = ''
            )
        else:
    ...
    def testPrivateSignalAttachmentUpdate(self):
        """Test PrivateSignalAttachmentUpdate"""
