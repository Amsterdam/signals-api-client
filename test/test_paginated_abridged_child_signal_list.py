...
class TestPaginatedAbridgedChildSignalList(unittest.TestCase):
    """PaginatedAbridgedChildSignalList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaginatedAbridgedChildSignalList:
        """Test PaginatedAbridgedChildSignalList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaginatedAbridgedChildSignalList`
        """
        model = PaginatedAbridgedChildSignalList()
        if include_optional:
            return PaginatedAbridgedChildSignalList(
                ...
                count = 123,
                results = [
                    signals_api_client.models.abridged_child_signal.AbridgedChildSignal(
    ...
    def testPaginatedAbridgedChildSignalList(self):
        """Test PaginatedAbridgedChildSignalList"""
