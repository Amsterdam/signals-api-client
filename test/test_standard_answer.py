...
class TestStandardAnswer(unittest.TestCase):
    """StandardAnswer unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StandardAnswer:
        """Test StandardAnswer
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StandardAnswer`
        """
