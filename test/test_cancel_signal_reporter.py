...
class TestCancelSignalReporter(unittest.TestCase):
    """CancelSignalReporter unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CancelSignalReporter:
        """Test CancelSignalReporter
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CancelSignalReporter`
        """
        model = CancelSignalReporter()
        if include_optional:
            return CancelSignalReporter(
                reason = ''
            )
        else:
            return CancelSignalReporter(
    ...
    def testCancelSignalReporter(self):
        """Test CancelSignalReporter"""
