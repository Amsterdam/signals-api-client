...
class TestPublicQuestionSerializerDetail(unittest.TestCase):
    """PublicQuestionSerializerDetail unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PublicQuestionSerializerDetail:
        """Test PublicQuestionSerializerDetail
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PublicQuestionSerializerDetail`
        """
        model = PublicQuestionSerializerDetail()
        if include_optional:
            return PublicQuestionSerializerDetail(
                key = '',
    ...
    def testPublicQuestionSerializerDetail(self):
        """Test PublicQuestionSerializerDetail"""
