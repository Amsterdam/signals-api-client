...
class TestLinks8(unittest.TestCase):
    """Links8 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Links8:
        """Test Links8
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Links8`
        """
        model = Links8()
        if include_optional:
            return Links8(
                ...
                var_self = signals_api_client.models._links_8_self._links_8_self(
