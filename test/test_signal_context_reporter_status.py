...
class TestSignalContextReporterStatus(unittest.TestCase):
    """SignalContextReporterStatus unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SignalContextReporterStatus:
        """Test SignalContextReporterStatus
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SignalContextReporterStatus`
        """
        model = SignalContextReporterStatus()
        if include_optional:
            return SignalContextReporterStatus(
                state = 'm',
    ...
    def testSignalContextReporterStatus(self):
        """Test SignalContextReporterStatus"""
