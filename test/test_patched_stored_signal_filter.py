...
class TestPatchedStoredSignalFilter(unittest.TestCase):
    """PatchedStoredSignalFilter unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PatchedStoredSignalFilter:
        """Test PatchedStoredSignalFilter
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PatchedStoredSignalFilter`
        """
        model = PatchedStoredSignalFilter()
        if include_optional:
            return PatchedStoredSignalFilter(
                links = '',
                display = '',
                id = 56,
                name = '',
    ...
    def testPatchedStoredSignalFilter(self):
        """Test PatchedStoredSignalFilter"""
