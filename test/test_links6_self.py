...
class TestLinks6Self(unittest.TestCase):
    """Links6Self unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Links6Self:
        """Test Links6Self
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Links6Self`
        """
        model = Links6Self()
        if include_optional:
            return Links6Self(
