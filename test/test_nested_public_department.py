...
class TestNestedPublicDepartment(unittest.TestCase):
    """NestedPublicDepartment unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NestedPublicDepartment:
        """Test NestedPublicDepartment
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NestedPublicDepartment`
        """
        model = NestedPublicDepartment()
        if include_optional:
            return NestedPublicDepartment(
                code = '',
                name = '',
                is_intern = True
            )
    ...
    def testNestedPublicDepartment(self):
        """Test NestedPublicDepartment"""
