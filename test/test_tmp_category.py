...
class TestTmpCategory(unittest.TestCase):
    """TmpCategory unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TmpCategory:
        """Test TmpCategory
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TmpCategory`
        """
        model = TmpCategory()
        if include_optional:
            return TmpCategory(
