...
class TestPaginatedSignalIdListList(unittest.TestCase):
    """PaginatedSignalIdListList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaginatedSignalIdListList:
        """Test PaginatedSignalIdListList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaginatedSignalIdListList`
        """
        model = PaginatedSignalIdListList()
        if include_optional:
            return PaginatedSignalIdListList(
                ...
                count = 123,
                results = [
                    signals_api_client.models.signal_id_list.SignalIdList(
                        id = 56, )
                    ]
            )
        else:
    ...
    def testPaginatedSignalIdListList(self):
        """Test PaginatedSignalIdListList"""
