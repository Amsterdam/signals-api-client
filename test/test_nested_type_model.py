...
class TestNestedTypeModel(unittest.TestCase):
    """NestedTypeModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NestedTypeModel:
        """Test NestedTypeModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NestedTypeModel`
        """
        model = NestedTypeModel()
        if include_optional:
            return NestedTypeModel(
                code = '',
