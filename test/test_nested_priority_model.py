...
class TestNestedPriorityModel(unittest.TestCase):
    """NestedPriorityModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NestedPriorityModel:
        """Test NestedPriorityModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NestedPriorityModel`
        """
        model = NestedPriorityModel()
        if include_optional:
            return NestedPriorityModel(
                priority = 'low',
                created_by = ''
            )
        else:
    ...
    def testNestedPriorityModel(self):
        """Test NestedPriorityModel"""
