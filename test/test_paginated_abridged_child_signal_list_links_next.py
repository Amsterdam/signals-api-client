...
class TestPaginatedAbridgedChildSignalListLinksNext(unittest.TestCase):
    """PaginatedAbridgedChildSignalListLinksNext unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaginatedAbridgedChildSignalListLinksNext:
        """Test PaginatedAbridgedChildSignalListLinksNext
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaginatedAbridgedChildSignalListLinksNext`
        """
        model = PaginatedAbridgedChildSignalListLinksNext()
        if include_optional:
            return PaginatedAbridgedChildSignalListLinksNext(
    ...
    def testPaginatedAbridgedChildSignalListLinksNext(self):
        """Test PaginatedAbridgedChildSignalListLinksNext"""
