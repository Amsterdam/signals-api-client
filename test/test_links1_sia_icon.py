...
class TestLinks1SiaIcon(unittest.TestCase):
    """Links1SiaIcon unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Links1SiaIcon:
        """Test Links1SiaIcon
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Links1SiaIcon`
        """
        model = Links1SiaIcon()
        if include_optional:
            return Links1SiaIcon(
