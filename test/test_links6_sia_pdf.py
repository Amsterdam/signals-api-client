...
class TestLinks6SiaPdf(unittest.TestCase):
    """Links6SiaPdf unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Links6SiaPdf:
        """Test Links6SiaPdf
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Links6SiaPdf`
        """
        model = Links6SiaPdf()
        if include_optional:
            return Links6SiaPdf(
