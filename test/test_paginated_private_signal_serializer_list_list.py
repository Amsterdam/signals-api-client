...
class TestPaginatedPrivateSignalSerializerListList(unittest.TestCase):
    """PaginatedPrivateSignalSerializerListList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaginatedPrivateSignalSerializerListList:
        """Test PaginatedPrivateSignalSerializerListList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaginatedPrivateSignalSerializerListList`
        """
        model = PaginatedPrivateSignalSerializerListList()
        if include_optional:
            return PaginatedPrivateSignalSerializerListList(
                ...
                count = 123,
                results = [
                    signals_api_client.models.private_signal_serializer_list.PrivateSignalSerializerList(
    ...
    def testPaginatedPrivateSignalSerializerListList(self):
        """Test PaginatedPrivateSignalSerializerListList"""
