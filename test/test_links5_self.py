...
class TestLinks5Self(unittest.TestCase):
    """Links5Self unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Links5Self:
        """Test Links5Self
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Links5Self`
        """
        model = Links5Self()
        if include_optional:
            return Links5Self(
