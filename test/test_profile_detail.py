...
class TestProfileDetail(unittest.TestCase):
    """ProfileDetail unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProfileDetail:
        """Test ProfileDetail
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProfileDetail`
        """
        model = ProfileDetail()
        if include_optional:
