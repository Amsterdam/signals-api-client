...
class TestPatchedPrivateSignalSerializerList(unittest.TestCase):
    """PatchedPrivateSignalSerializerList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PatchedPrivateSignalSerializerList:
        """Test PatchedPrivateSignalSerializerList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PatchedPrivateSignalSerializerList`
        """
        model = PatchedPrivateSignalSerializerList()
        if include_optional:
            return PatchedPrivateSignalSerializerList(
    ...
    def testPatchedPrivateSignalSerializerList(self):
        """Test PatchedPrivateSignalSerializerList"""
