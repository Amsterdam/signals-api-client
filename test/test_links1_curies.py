...
class TestLinks1Curies(unittest.TestCase):
    """Links1Curies unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Links1Curies:
        """Test Links1Curies
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Links1Curies`
        """
        model = Links1Curies()
        if include_optional:
            return Links1Curies(
