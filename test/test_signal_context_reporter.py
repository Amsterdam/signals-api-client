...
class TestSignalContextReporter(unittest.TestCase):
    """SignalContextReporter unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SignalContextReporter:
        """Test SignalContextReporter
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SignalContextReporter`
        """
        model = SignalContextReporter()
        if include_optional:
            return SignalContextReporter(
                signal_count = 5,
                open_count = 5,
                positive_count = 5,
                negative_count = 5
    ...
    def testSignalContextReporter(self):
        """Test SignalContextReporter"""
