...
class TestAreaGeoGeometry(unittest.TestCase):
    """AreaGeoGeometry unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AreaGeoGeometry:
        """Test AreaGeoGeometry
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AreaGeoGeometry`
        """
        model = AreaGeoGeometry()
        if include_optional:
            return AreaGeoGeometry(
                type = 'MultiPolygon',
                coordinates = [
