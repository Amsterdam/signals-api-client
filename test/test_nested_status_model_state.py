...
class TestNestedStatusModelState(unittest.TestCase):
    """NestedStatusModelState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NestedStatusModelState:
        """Test NestedStatusModelState
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NestedStatusModelState`
        """
        model = NestedStatusModelState()
        if include_optional:
            return NestedStatusModelState(
            )
        else:
            return NestedStatusModelState(
        )
    ...
    def testNestedStatusModelState(self):
        """Test NestedStatusModelState"""
