...
class TestStatusMessageSearchResult(unittest.TestCase):
    """StatusMessageSearchResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StatusMessageSearchResult:
        """Test StatusMessageSearchResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StatusMessageSearchResult`
        """
        model = StatusMessageSearchResult()
        if include_optional:
            return StatusMessageSearchResult(
                id = 56,
                title = '',
                text = '',
                active = True,
    ...
    def testStatusMessageSearchResult(self):
        """Test StatusMessageSearchResult"""
