...
class TestLinks1Archives(unittest.TestCase):
    """Links1Archives unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Links1Archives:
        """Test Links1Archives
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Links1Archives`
        """
        model = Links1Archives()
        if include_optional:
            return Links1Archives(
