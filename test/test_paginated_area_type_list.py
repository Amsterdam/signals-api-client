...
class TestPaginatedAreaTypeList(unittest.TestCase):
    """PaginatedAreaTypeList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaginatedAreaTypeList:
        """Test PaginatedAreaTypeList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaginatedAreaTypeList`
        """
        model = PaginatedAreaTypeList()
        if include_optional:
            return PaginatedAreaTypeList(
                ...
                count = 123,
                results = [
                    signals_api_client.models.area_type.AreaType(
                        id = 56, 
                        name = '', 
                        code = '', )
                    ]
    ...
    def testPaginatedAreaTypeList(self):
        """Test PaginatedAreaTypeList"""
