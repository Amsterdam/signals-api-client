...
class TestPublicSignalAttachment(unittest.TestCase):
    """PublicSignalAttachment unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PublicSignalAttachment:
        """Test PublicSignalAttachment
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PublicSignalAttachment`
        """
        model = PublicSignalAttachment()
        if include_optional:
            return PublicSignalAttachment(
                display = '',
                links = '',
                location = '',
                is_image = True,
    ...
    def testPublicSignalAttachment(self):
        """Test PublicSignalAttachment"""
