...
class TestPaginatedPublicQuestionSerializerDetailList(unittest.TestCase):
    """PaginatedPublicQuestionSerializerDetailList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaginatedPublicQuestionSerializerDetailList:
        """Test PaginatedPublicQuestionSerializerDetailList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaginatedPublicQuestionSerializerDetailList`
        """
        model = PaginatedPublicQuestionSerializerDetailList()
        if include_optional:
            return PaginatedPublicQuestionSerializerDetailList(
                ...
                count = 123,
                results = [
                    signals_api_client.models.public_question_serializer_detail.PublicQuestionSerializerDetail(
                        key = '', 
    ...
    def testPaginatedPublicQuestionSerializerDetailList(self):
        """Test PaginatedPublicQuestionSerializerDetailList"""
