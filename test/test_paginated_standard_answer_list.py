...
class TestPaginatedStandardAnswerList(unittest.TestCase):
    """PaginatedStandardAnswerList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaginatedStandardAnswerList:
        """Test PaginatedStandardAnswerList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaginatedStandardAnswerList`
        """
        model = PaginatedStandardAnswerList()
        if include_optional:
            return PaginatedStandardAnswerList(
                ...
                count = 123,
                results = [
                    signals_api_client.models.standard_answer.StandardAnswer(
                        is_satisfied = True, 
                        text = '', 
                        topic = '', 
                        open_answer = True, )
    ...
    def testPaginatedStandardAnswerList(self):
        """Test PaginatedStandardAnswerList"""
